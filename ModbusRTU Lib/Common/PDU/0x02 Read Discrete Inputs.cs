...
{
    public class ReadDiscreteInputsPDU : IProtocolDataUnit
    {
        ...
        public ReadDiscreteInputsPDU(int StartingAddress, int Quantity)
        {
            ...
            if ((Quantity < 1) || (Quantity > 2000))
                throw new ArgumentOutOfRangeException("ReadDiscreteInputs: Quantity", "Quantity must be in range 1 - 2000");

            this.StartingAddress = StartingAddress;
            this.Quantity = Quantity; 
            this.Value = new bool[Quantity];
        }
